...
ActiveRecord::Schema[7.0].define(version: 2025_08_27_102259) do
  ...
  create_table "decidim_voca_editor_files", force: :cascade do |t|
    t.string "file"
    t.string "path"
    t.bigint "decidim_author_id", null: false
    t.bigint "decidim_organization_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["decidim_author_id"], name: "decidim_voca_editor_files_author"
    t.index ["decidim_organization_id"], name: "decidim_voca_editor_files_constraint_organization"
  end
  ...
  add_foreign_key "decidim_voca_editor_files", "decidim_organizations"
  add_foreign_key "decidim_voca_editor_files", "decidim_users", column: "decidim_author_id"
